...
const Intro = () => {
  ...
  return (
    <>
      {/* Fixed Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <a
            href="#contact"
            className="hidden rounded-full border border-cyan-400/30 bg-cyan-400/5 px-5 py-2.5 text-sm font-medium text-cyan-400 transition hover:bg-cyan-400 hover:text-slate-950 sm:block"
          >
            Let's Talk
          </a>
        </div>
      ...
      <section
        id="intro"
        className="relative min-h-screen overflow-hidden bg-[#020617] text-white pt-20"
      >
          ...
          <div className="grid w-full items-center gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              >
                ...
                clean code, great user experiences and turning ideas into
            ...
            <div className="relative flex justify-center lg:justify-end">
              {/* Ambient glow */}
              <div className="absolute h-96 w-96 rounded-full bg-cyan-500/15 blur-3xl" />
              <div className="absolute h-64 w-64 rounded-full bg-blue-600/10 blur-2xl translate-x-16 translate-y-16" />

              {/* Outer ring */}
              <div className="relative p-[3px] rounded-full bg-gradient-to-br from-cyan-400/80 via-blue-500/50 to-violet-500/60">
                {/* Inner circle */}
                <div className="relative overflow-hidden rounded-full bg-slate-900">
                  <img
                    src={heroImage}
                    alt="Kannayira Moorthy"
                    className="h-[380px] w-[380px] object-cover object-center"
                  />
                  ...
                  {/* Status dot */}
                  <div className="absolute top-6 right-8 h-3 w-3 rounded-full bg-emerald-400 shadow-lg shadow-emerald-400/60" />
                </div>
              </div>
            </div>
          </div>
